...
**Shubham Chandra** teaches AI at the University of Chicago, where he guides 75+ students through applied AI coursework using a Socratic, discussion-driven method. He also leads AI efforts at Digital Realty, a $40B global enterprise, where he builds AI products and trains internal teams on both the tools he creates and how to build their own.

Previously, Shubham led strategy at NJOY (acquired by Altria for $2.8B) and served as Head of Business Operations at Garner Health.

He built this program because he kept seeing the same pattern: organizations that gave everyone access to AI tools but never redesigned a single process. Teams asking ChatGPT questions one at a time instead of rethinking how work actually flows through the organization. The tools were there. The thinking wasn't.

---

## Program philosophy

Most AI training asks the wrong question. It asks: "How do we get our people to use AI?"

That question thinks in a vertical. It starts with a person, adds a tool, and hopes for productivity. The result is a team that knows how to prompt ChatGPT but has no idea where AI actually fits in how the organization operates.

We ask a different question: **"Which processes should we redesign?"**

A business process is a horizontal. It runs through people and systems. A system includes tools, trainings, guardrails, metrics, and the people who operate within it. When you think about AI along this horizontal, you stop seeing it as a tool one person uses. You start seeing it as something that spans an entire workflow: the conversational AI that helps your people think, and the automated agents that handle work without human involvement.
...
Limited to 10 teams per cohort. Founding members receive the lowest price and direct instructor access to shape the curriculum based on their team's needs.

---

## Our guarantee

If your team completes both sessions and doesn't feel they've gained immediately applicable skills, we refund you. No questions, no forms, no friction.
